...
public class ErrorMessages {
    ...
    public static final String NULL_ERROR_MESSAGE = "userId should not be null";
    public static final String BAD_VALUE = "Please enter a Long value for the userId parameter.";
}